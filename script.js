    ...
    function showEventDetails(eventId) {
        ...
        if (eventId === 'seminario1') {
            ...
            eventDescription.innerHTML = `
                ...
                <h3> Immagini e video dell'evento:</h3>
                <div style="display: flex; justify-content: space-around; flex-wrap: wrap;">
                    <img src="images/seminario1.jpg" alt="Seminario sulla violenza sulle donne 1" style="max-width:45%; height:auto; margin: 5px;">
                    <img src="images/seminario2.jpg" alt="Seminario sulla violenza sulle donne 2" style="max-width:45%; height:auto; margin: 5px;">
                    <img src="images/seminario3.jpg" alt="Seminario sulla violenza sulle donne 3" style="max-width:45%; height:auto; margin: 5px;">
                    <img src="images/seminario5.jpg" alt="Seminario sulla violenza sulle donne 5" style="max-width:45%; height:auto; margin: 5px;">
                    <img src="images/seminario6.jpg" alt="Seminario sulla violenza sulle donne 6" style="max-width:45%; height:auto; margin: 5px;">
                    <img src="images/seminario7.jpg" alt="Seminario sulla violenza sulle donne 7" style="max-width:45%; height:auto; margin: 5px;">
                    <img src="images/seminario8.jpg" alt="Seminario sulla violenza sulle donne 8" style="max-width:45%; height:auto; margin: 5px;">
                    <video src="videos/video1.mp4" controls style="max-width:45%; height:auto; margin: 5px;"></video>
                    <video src="videos/video2.mp4" controls style="max-width:45%; height:auto; margin: 5px;"></video>
                    <video src="videos/video3.mp4" controls style="max-width:45%; height:auto; margin: 5px;"></video>
                    <img src="images/seminario4.jpg" alt="Seminario sulla violenza sulle donne 4" style="max-width:70%; height:auto; margin: 5px; object-fit: contain;">
                </div>
            `;
